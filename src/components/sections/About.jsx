...
const About = () => {
  ...
  return (
      <section id='about' className='flex relative justify-center items-center min-h-screen py-10 max-w-5xl mx-auto'>
        <RevealFramer>
      <div className='mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
            <div className='p-6 rounded-xl hover:translate-y-1 transition-all '>
                ...
                <ul className='list-disc list-inside bg-gray-900 px-2 py-5 rounded-xl border-amber-50 border space-y-2 min-h-40 h-auto'>
            ...
            <div className='p-6 rounded-xl hover:translate-y-1 transition-all '>
                ...
                <div className='bg-gray-900 px-2 py-5 rounded-xl border-amber-50 border min-h-40 h-auto'>
                    <div>
                        <h4>clean...</h4>
                        <p></p>
                    </div>
